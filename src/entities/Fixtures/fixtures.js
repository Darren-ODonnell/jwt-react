...
export const fixtureColumnDefs = [
    { headerName: 'Competition Name', field: 'name',         type: 'String',  min:8,  max:60,  required: true },
    { headerName: 'Home Team Name',   field: 'name',         type: 'String',  min:8,  max:60,  required: true  },
    { headerName: 'Away Team Name',   field: 'name',         type: 'String',  min:8,  max:60,  required: true  },
